...
import com.ui.model.CallDetailsDto;
import com.ui.model.CustomerDto;
import com.ui.model.Friend;
...
public class UIController {
	...
	private  static  String  ALLPLANS_URL="http://localhost:8282/plan/PlanApi/browsePlans";
	
	//Request URL - register
	private   static  String   REGISTER_URL="http://localhost:8282/cust/CustomerApi/register";
	
	//Request URL - login
	private   static  String  LOGIN_URL="http://localhost:8282/cust/CustomerApi/login";
	
	//Request URL - view profile
	private  static  String  PROFILE_URL="http://localhost:8282/cust/CustomerApi/viewProfile/{phoneNumber}";
	
	//Request URL - call details
	private  static  String  CALLDETAILS_URL = "http://localhost:8282/call/CallDetailsApi/{phoneNumber}";
	
	//Request URL - add friend
	private  static  String  ADDFRIEND_URL = "http://localhost:8282/friend/FriendApi/addFriend";
